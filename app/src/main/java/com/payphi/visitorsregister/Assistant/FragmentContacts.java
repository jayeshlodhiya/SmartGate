...
import com.payphi.visitorsregister.recyclerview.Contact;
import com.payphi.visitorsregister.recyclerview.ContactAdapter;
...
public class FragmentContacts extends Fragment implements ContactAdapter.ViewHolder.ClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       /* getActivity().supportInvalidateOptionsMenu();
        ((MainActivitychat)getActivity()).changeTitle(R.id.toolbar, "Contacts");*/
