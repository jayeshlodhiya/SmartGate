...
//        paydialog.show();
        ...
        map.put("DocId","");
        DocumentReference notificationDocs = FirebaseFirestore.getInstance().collection(socityCode).document("UserDoc").collection("Sousers").document(userref.getId()).collection("NotificationUpdateId").document(email);
