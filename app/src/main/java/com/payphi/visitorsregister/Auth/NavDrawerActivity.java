...
import mohak.uberux.BaseActivity;
import mohak.uberux.R;
import mohak.utils.SharedPrefManager;
...
/* case R.id.freebie:
                        ...
                        Intent intent = new Intent(NavDrawerActivity.this, MapActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.payment:
                        Toast.makeText(getApplicationContext(),"Settings",Toast.LENGTH_SHORT).show();
                        drawerLayout.closeDrawers();
                        Intent intent2 = new Intent(NavDrawerActivity.this, MapActivity.class);
        ...
        Auth.GoogleSignInApi.revokeAccess(mGoogleApiClient).setResultCallback(
                new ResultCallback<Status>() {
                    ...
                    public void onResult(@NonNull Status status) {
                        Intent intent = new Intent(NavDrawerActivity.this, AuthActivity.class);
                        startActivity(intent);
                    }
                }
        );
