    ...
    private void init(AttributeSet attrs, Context context) {
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs,
                    com.guo.duoduo.library.R.styleable.RadarScanView);
            circleColor = ta.getColor(com.guo.duoduo.library.R.styleable.RadarScanView_circleColor, circleColor);
            radarColor = ta.getColor(com.guo.duoduo.library.R.styleable.RadarScanView_radarColor, radarColor);
            tailColor = ta.getColor(com.guo.duoduo.library.R.styleable.RadarScanView_tailColor, tailColor);
            ta.recycle();
        }
