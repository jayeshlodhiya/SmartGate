...
/**
 * Created by swapnil.g on 4/27/2018.
 */
public class VendorAttendenceAdapter extends RecyclerView.Adapter<VendorAttendenceAdapter.MyViewHolder> implements View.OnLongClickListener {

    private Context mContext;
    VendorAttendenceAdapter vendorAdapter;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        public TextView title, count, dist, stat, datetime, visitorName, visitorId, whomtomeet, flatnumber, visitorMobile, vintimeId, visitorNumnber, visitorout, timer, vin, vout, vdocid;
        ...
        public Button bookButton, cancelbutton, callbutton, inButton, outButton;
        ...
        public MyViewHolder(View view) {
            ...
            vin = (TextView) view.findViewById(R.id.inttimeid);
            vout = (TextView) view.findViewById(R.id.vouttimeId);
            relativeLayout = (RelativeLayout) view.findViewById(R.id.vcardId);
            inButton = (Button) view.findViewById(R.id.vinId);
            outButton = (Button) view.findViewById(R.id.voutId);
    ...
    public VendorAttendenceAdapter(Context mContext, List<Vendors> cbookingsList, VendorAttendenceAdapter adapter) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.vendor_in_out, parent, false);
...
*/
       ...
       /* holder.vintimeId.setText(visitor.getVistorInTime());*/
        ...
        holder.vin.setText(vendors.getVin());
//        holder.whomtomeet.setText(visitor.getWhomTomeet());
        holder.vout.setText(vendors.getVout());
        holder.outButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (vendors.getVout() == null) {
...
*/        //bookingAdapter.notifyDataSetChanged();
    ...
    private void CreatePopup(final int position) {
        ...
        final View optDialogView = factory.inflate(R.layout.vendor_in_out, null);
        final AlertDialog optDialog = new AlertDialog.Builder(mContext).create();
