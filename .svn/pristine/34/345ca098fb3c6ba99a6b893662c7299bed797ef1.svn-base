...
package com.payphi.visitorsregister.api.services;
...
import com.payphi.visitorsregister.api.util.RecognizerChecker;
import com.payphi.visitorsregister.api.util.VersionConfig;
